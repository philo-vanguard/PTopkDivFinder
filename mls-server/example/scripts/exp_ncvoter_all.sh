...
do
    echo -e "vary data percentage = "${tid}" with data "${task[${tid}]}
    ./run_unit.sh ${tid} ${expOption} ${suppDefault} ${confDefault} ${topKDefault} ${tupleNumDefault} ${numOfProcessorDefault} ${filterEnumNumber} ${relevanceDefualt} ${diversityDefualt} ${lambda} ${w_fitness} ${w_unexpectedness} ${rationality_low_threshold} ${rationality_high_threshold} ${max_X_len_default} ${attributesUserInterested} ${predictConfThreshold}
done
fi
...
do
    ...
    ./run_unit.sh ${dataID} ${expOption} ${suppDefault} ${confDefault} ${topKDefault} ${tupleNumDefault} ${processor} ${filterEnumNumber} ${relevanceDefualt} ${diversityDefualt} ${lambda} ${w_fitness} ${w_unexpectedness} ${rationality_low_threshold} ${rationality_high_threshold} ${max_X_len_default} ${attributesUserInterested} ${predictConfThreshold}
done
fi
