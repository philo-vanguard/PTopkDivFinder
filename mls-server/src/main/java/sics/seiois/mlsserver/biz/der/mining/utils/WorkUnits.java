...
public class WorkUnits implements KryoSerializable {
    ...
    public WorkUnits(WorkUnits wu) {
        this.currrent = wu.getCurrrent();
        this.rhss = wu.getRHSs();
        this.allCount = wu.getAllCount();
        this.sameSet = wu.getSameSet();
        this.sameXConstSet = wu.getSameXConstSet();
        this.units = wu.getUnits();
        this.predicateMap = wu.getPredicateMapOrigin();
        this.pids = wu.getPids();
    }
...
//                String key = p.getOperand1().toString_(0);
    ...
    public LinkedHashMap<String, List<Integer>> getPredicateMapOrigin() {
        return this.predicateMap;
    }
